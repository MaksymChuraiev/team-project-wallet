...
export function ModalAddTransaction() {
  ...
  const isModalOpen = useSelector(transactionSelectors.isModalAddTransOpen)
  ...
  return (
    isModalOpen && <>
      ...
      >
        ...
        />
        <Form transaction={transaction} updateTransaction={updateTransaction} handleInputChange={handleInputChange} />
